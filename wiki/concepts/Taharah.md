...
```mermaid
graph TD
    Level4["Tingkat 4: Kesucian Batin Terdalam (Sirr) <br> Membersihkan hati dari segala sesuatu selain Allah SWT (Maqam Nabi & Shiddiqin)"] --> Level3["Tingkat 3: Kesucian Hati (Qalb) <br> Menyucikan kalbu dari penyakit hati: hasad, riya, takabur, ujub"]
    Level3 --> Level2["Tingkat 2: Kesucian Anggota Tubuh <br> Menjaga panca indra dan anggota jasad dari maksiat & dosa"]
    Level2 --> Level1["Tingkat 1: Kesucian Fisik Lahiriah <br> Menyucikan jasad, pakaian, dan tempat dari najis, kotoran, & hadas"]
```
